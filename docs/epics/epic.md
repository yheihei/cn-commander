...
- [ ] **task-7-4**: 駐留システム（アイテム補給、入院）
  - [ ] **task-7-4-1**: 駐留コマンドUI実装（ActionMenuに駐留オプション追加、3マス判定）
  - [ ] **task-7-4-2**: 拠点選択モード実装（拠点選択モード遷移、ハイライト表示）  
  - [ ] **task-7-4-3**: 駐留実行処理（軍団を拠点に移動、駐留状態管理）
  - [ ] **task-7-4-4**: 駐留軍団の表示・管理（駐留中軍団表示、駐留解除処理）
- [ ] **task-7-5**: 拠点UI（拠点ActionMenu、施設サブメニュー、軍団編成画面）
  ...
  - [ ] **task-7-5-4**: その他施設のサブメニュー実装タスク作成
