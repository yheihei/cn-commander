...
- [ ] **task-1-5**: キャラクター顔画像アセット読み込みシステム（40x40px、キャラクター個別対応）
...
- **task-12-4**: 軍団UIシステム
  ...
  - [ ] **task-12-4-3**: 待機コマンド実装（ActionMenuに待機オプション追加、視界ボーナス）
  ...
  - [ ] **task-12-4-8**: 軍団情報パネルへの顔画像表示機能追加（左側に40x40px顔画像、右側にステータス）
