...
export class PreloadScene extends Phaser.Scene {
  ...
  private loadCharacterAssets(): void {
    ...
    this.load.spritesheet('sakuya', 
      'assets/images/characters/Sakuya-1.png',
