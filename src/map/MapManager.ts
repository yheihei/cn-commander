...
export class MapManager {
  ...
  public createEmptyMap(width: number, height: number, defaultTileType: TileType = TileType.PLAIN): void {
  ...
  public getTileAtPixel(pixelX: number, pixelY: number, layerName: string = 'terrain'): MapTile | null {
    const layer = this.layers.get(layerName);
    if (layer) {
