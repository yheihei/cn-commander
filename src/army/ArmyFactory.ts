...
export class ArmyFactory {
  ...
  static createCustomArmy(
    ...
    const commander = CharacterFactory.createCharacter(scene, x, y, commanderType);
    const army = armyManager.createArmy(commander, x, y);
